...
# === Flatten nested park_hand_hr_rate_map for dataframe
park_hand_hr_rows = []
...
# === Convert all dicts to pandas dataframes
...
# === Creation SQL statements for all tables ===
create_table_sqls = {
    'park_hr_rate_map': """
...
# Helper function: create table and upload dataframe to Snowflake
...
# List all tables and dfs to upload
tables_and_dfs = [
